...
public class PipelineBuilderUseWhenPredicateTests : PipelineBuilderConditionTestsBase
{
    ...
    public static TheoryData<Func<IPipelineBuilderCompleteTestSut, IPipelineBuilderCompleteTestSut>> ParamNullChecksTestData =>
        ...
        {
            (builder) => builder
                .UseWhen((Func<PipelineArg, bool>)null!, ConfigurationWithoutTarget, PipelineBuilderFactory),
            (builder) => builder
            ...
            (builder) => builder
                ...
                .UseWhen((Func<PipelineArg, bool>)null!, ConfigurationWithoutTarget, PipelineBuilderFactoryWithServiceProvider),
            (builder) => builder
            ...
            (builder) => builder
                .UseWhen((Func<PipelineArg, bool>)null!, ConfigurationWithoutTarget),
            (builder) => builder
