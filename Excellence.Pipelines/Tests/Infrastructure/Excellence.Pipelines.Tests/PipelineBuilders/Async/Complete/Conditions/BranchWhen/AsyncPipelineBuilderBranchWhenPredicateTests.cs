...
namespace Excellence.Pipelines.Tests.PipelineBuilders.Async.Complete
{
    public class AsyncPipelineBuilderBranchWhenPredicateTests : AsyncPipelineBuilderBranchWhenTestsBase
    {
        ...
        public static TheoryData<Func<IAsyncPipelineBuilderCompleteTestSut, IAsyncPipelineBuilderCompleteTestSut>> ServiceProviderNullChecksTestData =>
            new TheoryData<Func<IAsyncPipelineBuilderCompleteTestSut, IAsyncPipelineBuilderCompleteTestSut>>()
            {
                (builder) => builder
        ...
        public void BranchWhen_ServiceProvider_IsNull_ThrowsException(Func<IAsyncPipelineBuilderCompleteTestSut, IAsyncPipelineBuilderCompleteTestSut> pipelineBuilderConfiguration)
        {
            var sut = CreateSut();
        ...
        )
        {
            ...
            var actualResult = await pipeline.InvokeAsync(this.Arg, CancellationToken.None);
