...
/// <inheritdoc cref="IPipelineBuilderStepInterface{TParam, TPipelineBuilder}" />
/// <inheritdoc cref="IPipelineBuilderUseWhen{TParam, TPipelineBuilder}" />
/// <inheritdoc cref="IPipelineBuilderBranchWhen{TParam, TPipelineBuilder}" />
public partial class PipelineBuilderComplete<TParam, TPipelineBuilder> :
    PipelineBuilderCoreComplete<Action<TParam>, TPipelineBuilder>,
    IPipelineBuilderStepInterface<TParam, TPipelineBuilder>,
    IPipelineBuilderUseWhen<TParam, TPipelineBuilder>,
    IPipelineBuilderBranchWhen<TParam, TPipelineBuilder>
    where TPipelineBuilder : class, IPipelineBuilderCore<Action<TParam>, TPipelineBuilder>,
    IPipelineBuilderCoreUtils<Action<TParam>, TPipelineBuilder>,
    IPipelineBuilderCoreUseUtils<Action<TParam>, TPipelineBuilder>,
    IPipelineBuilderStepInterface<TParam, TPipelineBuilder>,
    IPipelineBuilderUseWhen<TParam, TPipelineBuilder>,
    IPipelineBuilderBranchWhen<TParam, TPipelineBuilder>
{
