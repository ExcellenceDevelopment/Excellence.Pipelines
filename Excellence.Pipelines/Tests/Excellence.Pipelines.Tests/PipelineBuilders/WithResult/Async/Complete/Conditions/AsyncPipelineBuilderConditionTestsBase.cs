...
{
    protected static Func<Func<PipelineArg, CancellationToken, Task<PipelineArg>>, Func<PipelineArg, CancellationToken, Task<PipelineArg>>> ComponentForConfiguration =>
