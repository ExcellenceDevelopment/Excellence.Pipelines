...
namespace Excellence.Pipelines.Tests.PipelineBuilders.Async.Complete
{
    public class AsyncPipelineBuilderUseWhenPredicateTests : AsyncPipelineBuilderConditionTestsBase
    {
        ...
        public void UseWhen_ServiceProvider_IsNull_ThrowsException(Func<IAsyncPipelineBuilderCompleteTestSut, IAsyncPipelineBuilderCompleteTestSut> pipelineBuilderConfiguration)
        {
            var sut = CreateSut();
